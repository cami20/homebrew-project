...
class Yeast(db.Model):
	...
	yeast_type = db.Column(db.String(15))
	ferment_temp_min = db.Column(db.Float)
	ferment_temp_max = db.Column(db.Float)
	alcohol_tolerance_min = db.Column(db.Float)
	alcohol_tolerance_max = db.Column(db.Float)
	yeast_format = db.Column(db.String(10))
...
class Hops(db.Model):
	...
	alpha_min = db.Column(db.Float)
	alpha_max = db.Column(db.Float)
	beta_min = db.Column(db.Float)
	beta_max = db.Column(db.Float)
...
class Fermentables(db.Model):
	...
	requires_mashing = db.Column(db.String(10))
...
class Project(db.Model):
	...
	yeast = db.Column(db.String(35))
	hops = db.Column(db.String(35), nullable=False)
	hops2 = db.Column(db.String(35))
	hops3 = db.Column(db.String(35))
	fermentables = db.Column(db.String(35), nullable=False)
	fermentables2 = db.Column(db.String(35))
	fermentables3 = db.Column(db.String(35))
